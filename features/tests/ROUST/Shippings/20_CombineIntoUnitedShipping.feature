...
Feature:
    ...
    Scenario Outline: 20_CombineIntoUnitedShipping
       ...
       # Выставляем галку и переводим в статус "В перевозке" через МО
        ...
        Examples:
            | login coordinator           | shipping warehouse | delivery warehouse | countPallet | shipping date | delivery date | materialRef | tariffication | transportCompany    | driver                                      |Weight|
            | Roust Transport Coordinator | РУСТ ИНК Москва          | Котовский          | 4           | 1             | 7             | 303308      | LTL           | ООО «Кот» | Абдуллин Рамиль Ибрагимович (77  МТ 220021) |1350      |
