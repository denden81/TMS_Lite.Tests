...
Feature: Create tariff and check shippings
    ...
    Scenario Outline: 04_CreateShippingsChooseACarrierFTLTariff ч1
        ...
        Examples:
            ...
            | Roust Transport Coordinator | РУСТ ИНК Москва          | Котовский          | ООО «Кот» | Тент 20т     | FTL                 | 58700    | 0              | 30              |
    ...
    Scenario Outline: 04_CreateShippingsChooseACarrierFTLTariff ч2
      #Создаем перевозку
        ...
        Examples:
            ...
            | Roust Transport Coordinator | РУСТ ИНК Москва          | Котовский          | 33          | 1             | 7             | FTL           | 10500  | 15000 | ООО «Кот» |
