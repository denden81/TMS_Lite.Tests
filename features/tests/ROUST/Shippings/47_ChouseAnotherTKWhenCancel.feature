...
Feature: Create tariff and check shippings
    ...
    Scenario Outline:  47_ChouseAnotherTKWhenCancel ч1
        ...
        Examples:
            ...
            | Roust Transport Coordinator | РУСТ ИНК Москва    | КТмухино          | ООО «Кот» | ООО «Мок»     | Тент 20т     | FTL                 | 58700    | 60000     | 0              | 30              | 4800            | 3500        | 5100           | 2300         |
    ...
    Scenario Outline:  47_ChouseAnotherTKWhenCancel ч2
        ...
        Examples:
            ...
            | Roust Transport Coordinator | РУСТ ИНК Москва    | КТмухино           | 20          | 1             | 7             | 105543       | ООО «Кот» | 58700    | 63500     | 76200         | 18000  | 1000    |
