...
Feature:
    ...
    Scenario Outline: 15_WaybillsCancel
        ...
        And thes element "Окно информация при создании новой накладной" contains the text "Информация"
        # перевести  накладную в статус "Отменить накладную"
        And I moving waybills status forward "Отменить накладную"
        ...
        Examples:
            ...
            | Roust Transport Coordinator | РУСТ ИНК Москва          | Котовский          | 4           | 1             | 7             | 105543       |
