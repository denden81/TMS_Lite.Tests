...
Feature:
    ...
    Scenario Outline: 13_WaybillsFullRefund
        ...
        And I set status fullrefund and returnReason "<reason>" returnType "<type>" vat "<vat>" comment "<comment>"
        ...
        Examples:
            | login coordinator           | shipping warehouse | delivery warehouse | countPallet | shipping date | delivery date | materialTent | reason                                  | type   | vat  | comment |
            | Roust Transport Coordinator | РУСТ ИНК Москва    | Котовский          | 4           | 1             | 7             | 105543       | Несоответствие логистических требований | Полный | 2000 | Возврат |
