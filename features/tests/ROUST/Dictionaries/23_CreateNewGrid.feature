...
Feature:
    ...
    Scenario Outline: 23_CreateNewGrid ч1
        ...
        Examples:
            ...
            | Roust Transport Coordinator | Roust  | Транспортный координатор |
    ...
    Scenario Outline: 23_CreateNewGrid ч2
       # Заходим новым юзером
        ...
        And I drag this field in grid "Базовая стоимость, без НДС" to the inputfields "Выбранные поля"
        ...
        And thes element "Грид Пользовательский" contains the text "Базовая стоимость, без НДС"
       ...
       # Удаляем набор старых полей
        ...
        And I drag this field in grid "Базовая стоимость, без НДС" to the inputfields "Доступные поля"
       ...
       # Добавляем набор новых полей
        And I drag this field in grid "Груз" to the inputfields "Выбранные поля"
        ...
        And I click on this in button "Сохранить"
        # Проверяем что поля есть в гриде
        And thes element "Грид Пользовательский" contains the text "Груз"
        ...
        And thes element "Грид Пользовательский" contains the text "ТТН"
