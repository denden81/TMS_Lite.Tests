...
Feature:
    ...
    Scenario Outline: 44_TransportCompanies
        ...
        And I add data "random" to the inputfields "ИНН *"
        And I add data "random" to the inputfields "КПП *"
        ...
        And I add data "random" to the inputfields "Время на рассмотрения заявки, мин *"
        ...
        And I set filter "random" in field "ИНН"
        And I set filter "random" in field "КПП"
        ...
        And I set filter "random" in field "Время на рассмотрения заявки, мин"
