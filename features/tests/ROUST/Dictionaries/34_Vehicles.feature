...
Feature:
    ...
    Scenario Outline: 34_Vehicles
        ...
        And I add data "random name tc" to the inputfields "Марка прицепа"
        ...
        And I set filter "random name tc" in field "Марка прицепа"
        ...
        Examples:
            ...
            | Roust Transport Coordinator |Тент 20т|
