...
Feature:
    ...
    Scenario Outline: 12_WaybillsForwardBack
        ...
        # перевести  накладную в статус "Прибыл на выгрузку"
        And I moving waybills status forward "Прибыл на выгрузку"
        # перевести  накладную в статус "Выгружен"
        And I moving waybills status forward "Выгружен"
        # перевести  накладную в статус "Принят"
        And I moving waybills status forward "Принят"
        # перевести  накладную в статус "Перевести в архив"
        And I moving waybills status forward "Перевести в архив"
        # откатить накладную в статус "Принята"
        And I moving waybills status revert "Откатить накладную в статус Принята"
        # откатить накладную в статус "Выгружен"
        And I moving waybills status revert "Откатить накладную в статус Выгружен"
        # откатить накладную в статус "Прибыл на выгрузку"
        And I moving waybills status revert "Откатить накладную в статус Прибыл на выгрузку"
        # откатить накладную в статус "Отгружен"
        And I moving waybills status revert "Откатить накладную в статус Отгружен"
        # откатить накладную в статус "Торг-12 получен"
        And I moving waybills status revert "Откатить накладную в статус Торг-12 получен"
        # откатить накладную в статус "Подбор завершен"
        And I moving waybills status revert "Откатить накладную в статус Подбор завершен"
        # откатить накладную в статус "Взят в подбор"
        And I moving waybills status revert "Откатить накладную в статус Взят в подбор"
        # откатить накладную в статус "Получен складом"
        And I moving waybills status revert "Откатить накладную в статус Получен складом"
        # откатить накладную в статус "В перевозке"
