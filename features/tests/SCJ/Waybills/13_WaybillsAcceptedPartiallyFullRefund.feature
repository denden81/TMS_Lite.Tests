...
Feature:
    ...
    Scenario Outline: 13_WaybillsAcceptedPartiallyFullRefund
        ...
        # перевести  накладную в статус "Принят частично"
        And I moving waybills status forward "Принят частично"
        # перевести  накладную в статус "Возврат"
        And I moving waybills status forward "Возврат"
        ...
        And I press "Enter"
        And I expect this element "Loader" is not visible
        Then I see element "random number" in status "Возврат"
