...
Feature:
    ...
    Scenario Outline: 12_WaybillsPickup
        ...
        # откатить накладную в статус "Создан"
        And I moving waybills status revert "Откатить накладную в статус Создан"
        ...
        Examples:
            ...
            | SCJ Transport Coordinator | Котоламповый   | 4               | 4              | 1             | 7             | 12       | 7500      | 4      |
