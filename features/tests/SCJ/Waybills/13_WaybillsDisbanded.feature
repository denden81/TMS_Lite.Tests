...
Feature:
    ...
    Scenario Outline: 13_WaybillsDisbanded
        ...
        And I moving waybills status forward "Отменить заказ"
        # перевести  накладную в статус "Расформирован"
        And I moving waybills status forward "Расформирован"
        ...
        And I press "Enter"
        And I expect this element "Loader" is not visible
        Then I see element "random number" in status "Расформирован"
