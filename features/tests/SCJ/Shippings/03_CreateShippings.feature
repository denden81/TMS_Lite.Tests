...
Feature: Create
    ...
    Scenario Outline: 03_CreateShippings
        ...
        When I click on this element "Создать перевозку"
        ...
        And I press "Enter"
        And I expect this element "Loader" is not visible
        Then I see element "<transportCompany>" in status "Создан"
        ...
        Examples:
            ...
            | SCJ Transport Coordinator | Томилино           | Котовский          | 4               | 8           | 12              | 1             | 7             | LTL           | 5650    | 15000 | Транслогистик    |
