...
Feature:
    ...
    Scenario Outline: 30_Leadtime
        ...
        And I add data "random" to the inputfields "Leadtime, дней *"
        ...
        And I add data "random 2" to the inputfields "Leadtime, дней *"
        ...
        Examples:
            ...
            | SCJ Transport Coordinator | АО Тандер | Томилино           | Астрахань    | АО Тандер Астрахань|
