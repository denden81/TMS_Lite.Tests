...
Feature:
    ...
    Scenario Outline: 38_ShippingWarehouses
        ...
        And I add data "random" to the inputfields "Код склада отгрузки *"
        ...
        #Выставляем фильтры
        And I set filter "random" in field "Код склада отгрузки"
        ...
        Examples:
            ...
            | SCJ Transport Coordinator | г. Москва | Москва, ул Октябрьская, д 33 | Москва г |
