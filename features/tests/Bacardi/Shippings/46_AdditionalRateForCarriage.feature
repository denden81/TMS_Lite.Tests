...
Feature: Create tariff and check shippings
    ...
    Scenario Outline:  46_AdditionalRateForCarriage ч1
        ...
        Examples:
            ...
            | Bac Transport Coordinator | ДЦ Москва          | Котовский          | Симпл Деливери Груп | Тент 20т     | FTL                 | 58700    | 0              | 30              | 4800          |            3500  |  5100     |2300    |
    ...
    Scenario Outline:  46_AdditionalRateForCarriage ч2
        ...
        # Проверяем историю
        And thes element "История в накладной" contains the text "Значение поля Базовая стоимость, без НДС изменено на '(пусто)'"
        And thes element "История в накладной" contains the text "Значение поля Общая стоимость, с НДС изменено на '(пусто)'"
        And thes element "История в накладной" contains the text "Значение поля Общая стоимость, без НДС изменено на '(пусто)'"
        ...
        And thes element "Окно информация при создании новой накладной" contains the text "Информация"
        #Проверяем историю
        And thes element "История в накладной" contains the text "Значение поля Базовая стоимость, без НДС изменено на '58700' "
        Then thes element "История в накладной" contains the text "Значение поля Общая стоимость, с НДС изменено на '70440'"
        ...
        Examples:
            ...
            | Bac Transport Coordinator | ДЦ Москва          | Котовский          |   Котишкин          |20           |1          |1             | 7             |   2            |105543        | Симпл Деливери Груп   |58700 |63500  |  76200 |18000|1000   |
