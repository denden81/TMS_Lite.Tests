...
Feature:
    ...
    Scenario Outline: 19_RejectRequest
        ...
        And I press "Enter"
        And I expect this element "Loader" is not visible
        Then I see element "random number" in status "Отклонена ТК"
        ...
        Examples:
            | login coordinator           | shipping warehouse | delivery warehouse | countPallet | shipping date | delivery date | materialTent |tariffication|transportCompany|
            | Bac Transport Coordinator | ДЦ Москва          | Котовский          | 4           | 1             | 7             | 105543       |FTL         |Симпл Деливери Груп  |
