...
Feature: Create tariff and check shippings
    ...
    Scenario Outline: 04_CreateShippingsChooseACarrierFTLTariff ч1
        ...
        Examples:
            ...
            | Bac Transport Coordinator	  | ДЦ Москва          | Газпромбанк        | Симпл Деливери Груп | Тент 20т     | FTL                 | 58700    | 0              | 30              |
    ...
    Scenario Outline: 04_CreateShippingsChooseACarrierFTLTariff ч2
      #Создаем перевозку
        ...
        Examples:
            ...
            | Bac Transport Coordinator | ДЦ Москва          | Газпромбанк        | 33          | 1             | 7             | FTL           | 10500  | 15000 | Симпл Деливери Груп |
