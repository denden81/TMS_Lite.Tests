...
Feature: Order's statuses movement with 
    ...
    Scenario: Create order in status created, move to archive and back, then delete
        ...
        Then I expects that element "orderPickupNumber" does not exist
        When I click on this element "create_order_button"
		And  I add "order_pickup_value" to the inputfields "order_number"
        ...
        And  I add "pickup_sold_to_value" to the inputfields "sold_to_order_card"
        ...
        And  I click on this element "orderPickupNumber"
