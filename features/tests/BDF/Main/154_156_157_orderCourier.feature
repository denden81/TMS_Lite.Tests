...
@test1
@statusOrder
Feature: Order's statuses movement with 
         delivery method = courier

    Scenario: Create order in status created, move to archive and back, then delete
        Given I log in as a user Administrator on homepage
        Then I expects that element "orderCourierNumber" does not exist
        When I click on this element "create_order_button"
		And  I add "order_courier_value" to the inputfields "order_number"
        ...
        And  I add "courier_sold_to_value" to the inputfields "sold_to_order_card"
        ...
        And  I click on this element "orderCourierNumber"
